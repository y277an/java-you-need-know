...
public class ConnectManage {
    ...
    public synchronized void updateConnectServer(List<String> addressList) {
        ...
        Set<SocketAddress> serverNodesSet = new HashSet<>();
        for (int i = 0; i < addressList.size(); ++i) {
            ...
            if (array.length == 2) {
                ...
                serverNodesSet.add(remotePeer);
            }
        }

        for (final SocketAddress serverNodeAddress : serverNodesSet) {
        ...
        for (int i = 0; i < channels.size(); ++i) {
            ...
            SocketAddress remotePeer = channel.remoteAddress();
            if (!serverNodesSet.contains(remotePeer)) {
